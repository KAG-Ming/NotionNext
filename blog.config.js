...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '74d623c240704799ac0191e382c9b382',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'KagurazakaMio', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.kagurazakamio.me', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'kagurazakamio','技术','blog','博客'// 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'kagu_Ming@proton.me', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://x.com/KagurazakaMi0', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/KAG-Ming', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    ...
    {
      name: 'Welcome to the Theater',
      artist: 'The 1999',
      url: 'https://music.163.com/song/media/outer/url?id=2603055754.mp3',
      cover:
        'http://p2.music.126.net/6v4cQ_RXOwGLsNftTGdeaw==/109951169730741953.jpg'
    },
    {
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '12318272274', // 对应歌单的 id
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-QE28B814R0', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
